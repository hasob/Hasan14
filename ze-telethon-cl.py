...
try:
    with open(filename, 'r') as f:
        data = json.load(f)
        api_id = data['26004411']
        api_hash = data['4b9a73c02e89da49ef7f7df8a7e30f65']
        bot_token = data['6720857511:AAEgLIT3fT751_jsMJwr8hr5KI-Qrgly0VA']
        DEVLOO = data['DEVLOO']
        MAX_ACCOUNTS = data['500']
        id_bot = bot_token.split('6720857511:AAEgLIT3fT751_jsMJwr8hr5KI-Qrgly0VA')[0]  # Extract id_bot from bot_token
        ...
        user_bot = response_data['result']['hasan']
except FileNotFoundError:
    api_id = Mody.26004411
    api_hash = Mody.4b9a73c02e89da49ef7f7df8a7e30f65
    bot_token =6720857511:AAEgLIT3fT751_jsMJwr8hr5KI-Qrgly0VA
    DEVLOO = Mody.OWNER
    MAX_ACCOUNTS = Mody.500
    id_bot = Mody.6798245975
    user_bot =Gkyjjbvvbot
    
    data = {
        'api_id': 26004411,
        'api_hash': 4b9a73c02e89da49ef7f7df8a7e30f65,
        'bot_token': 6720857511:AAEgLIT3fT751_jsMJwr8hr5KI-Qrgly0VA,
        'DEVLOO': DEVLOO,
        'MAX_ACCOUNTS': 500,
        'user_bot': Gkyjjbvvbot,
...
async def mainlogin(event):
    async with bot.conversation(event.sender_id) as conv:
        ...
        try: 
            ...
            print(" 26004411 4b9a73c02e89da49ef7f7df8a7e30f65")
            await conv.send_message("26004411 أو 4b9a73c02e89da49ef7f7df8a7e30f65 غير صحيح. يرجى التحقق والمحاولة مرة أخرى.")
        except Exception as e:
